/**
 * @file pairVector.hpp
 * @brief A header file that defines the pair_v class, which is a container for two vectors and their reversed versions.
 * The pair_v class provides various functionalities for comparing, printing, summing, and swapping two vectors together.
 * @author Ali Lafi
 * @date 2025/9/25
 */
...
#pragma once
#ifndef OPENUDT___UDT_VECTOR_PAIRVECTOR_HPP
#define OPENUDT___UDT_VECTOR_PAIRVECTOR_HPP
...
#endif // OPENUDT___UDT_VECTOR_PAIRVECTOR_HPP